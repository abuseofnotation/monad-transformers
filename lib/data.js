...
exports.maybe = {
  ...
  fold (interpret, value, maybeVal) {
      return maybeVal.maybeVal === undefined ? (interpret.onNothing || idFunc )() : value(maybeVal.maybeVal)
  },
  // Custom functions
  get (key, val) {
...
exports.writer = {
  ...
  // ((val) => b, M([val, log])) => b
  fold (interpret, value, writerVal) {
    (interpret.onWriterLog || idFunc)(writerVal[1])
